...
## 0.28.0 - 2024-06-27 - Sizing pass, `UiStack` and GIF support
### ✨ Highlights
...
* Don't persist `Area` state [#4577](https://github.com/emilk/egui/pull/4577) by [@emilk](https://github.com/emilk)
...
* Hide toolip when opening `ComboBox` drop-down [#4546](https://github.com/emilk/egui/pull/4546) by [@abey79](https://github.com/abey79)
