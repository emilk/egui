...
## Unreleased
### Changed 🔧
* `InputState`: all press functions again include key repeates (like in egui 0.19).

### Fixed 🐛
* Fix key-repeats for `TextEdit`, `Slider`s, etc ([#2416](https://github.com/emilk/egui/pull/2416)).
