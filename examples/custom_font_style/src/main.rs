...
fn configure_text_styles(ctx: &egui::Context) {
    ...
    let text_styles: BTreeMap<TextStyle, FontStyle> = [
        (TextStyle::Heading, FontStyle::simple(25.0, SystemUi)),
        (heading2(), FontStyle::simple(22.0, SystemUi)),
        (heading3(), FontStyle::simple(19.0, SystemUi)),
        (TextStyle::Body, FontStyle::simple(16.0, SystemUi)),
        (TextStyle::Monospace, FontStyle::simple(12.0, Monospace)),
        (TextStyle::Button, FontStyle::simple(12.0, SystemUi)),
        (TextStyle::Small, FontStyle::simple(8.0, SystemUi)),
    ]
    .into();
