...
## 0.28.0 - 2024-07-01 - Better integration of a eframe in a bigger website
### 🔧 Changed
* Refactor web event handling: break up into smaller functions [#4717](https://github.com/emilk/egui/pull/4717) by [@emilk](https://github.com/emilk)


## 0.28.0 - 2024-06-27 - Support an eframe canvas as part of a bigger web page
### ✨ Highlights
