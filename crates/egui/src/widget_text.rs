...
use epaint::text::style::{FontFeatures, FontVariations, FontWeight, FontWidth};
...
impl RichText {
    ...
    pub fn font_height(&self, fonts: &mut epaint::Fonts<'_>, style: &Style) -> f32 {
...
impl WidgetText {
    ...
    /// Returns a value rounded to [`emath::GUI_ROUNDING`].
    pub(crate) fn font_height(&self, fonts: &mut epaint::Fonts<'_>, style: &Style) -> f32 {
        match self {
